...
| 07 | `07-second-brain` | 第二大腦三層結構 + GitHub 版控同步 |
| 08 | `08-browser` | 瀏覽器控制（Playwright + open-computer-use）|
...
對選取的每個 skill：
```bash
npx skills add arnohsu-0930/antigravity-lazy-pack --skill <skill名稱> -g -y
```
